; copied from /home/h03/frka/general_procs/legend.pro
; Kate found it on the internet
; modified to protect bottom from being modified
; modified to use background colour if /clear is used
; NAME:
;       LEGEND
; PURPOSE:
...
;-
pro legend, items, BOTTOM_LEGEND=bottom0, BOX = box, CENTER_LEGEND=center, $
...
if (n_elements(bottom0) GT 0) then bottom = bottom0
;
