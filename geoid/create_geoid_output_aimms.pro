PRO create_geoid_output_aimms,fname_out
...
;fname_out = Output NetCDF file containing corrected GPS altitude data 
 ...
 NCDF_ATTPUT, id, /GLOBAL, 'FAAM_core_file', fname_core 
 NCDF_ATTPUT, id, /GLOBAL, 'AIMMS_file', fname 
 NCDF_ATTPUT, id, /GLOBAL, 'History', 'V01'
 NCDF_ATTPUT, id, /GLOBAL, 'GEOID', 'WW15MGH.GRD'
 NCDF_ATTPUT, id, /GLOBAL, 'Comment', 'Calculated using aimms_gps_geoid_correction.scr'
 ...
 zid = NCDF_VARDEF(id, 'ALT_AIMMS', [nt], /float)
 NCDF_ATTPUT, id, zid, 'long_name', z.long_name
 NCDF_ATTPUT, id, zid, 'units', z.units 
 NCDF_ATTPUT, id, zid, '_fillvalue', z._fillvalue 

 zfid = NCDF_VARDEF(id, 'ALT_AIMMS_FLAG', [nt], /byte)
 NCDF_ATTPUT, id, zfid, 'long_name', 'Flag for AIMMS_ALT'
 ...
 zcid = NCDF_VARDEF(id, 'ALT_AIMMSC', [nt], /float)
 ...
 zcfid = NCDF_VARDEF(id, 'ALT_AIMMSC_FLAG', [nt], /byte)
 NCDF_ATTPUT, id, zcfid, 'long_name', 'Flag for AIMMS_ALTC'
